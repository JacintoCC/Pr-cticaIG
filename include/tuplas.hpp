...
// ---------------------------------------------------------------------
// tupla += tupla
inline void operator += ( Tupla3f & t1, const Tupla3f & t2 )
{
   t1=t1+t2;
}
...
// ---------------------------------------------------------------------
//  = ||tupla-tupla|| distancia
inline float distancia ( const Tupla3f & v1, const Tupla3f & v2 )
{
   return sqrt
         (  (v1.coo[X]-v2.coo[X])*(v1.coo[X]-v2.coo[X]) +
            (v1.coo[Y]-v2.coo[Y])*(v1.coo[Y]-v2.coo[Y]) +
            (v1.coo[Z]-v2.coo[Z])*(v1.coo[Z]-v2.coo[Z])
         );
}
...
struct Tupla3i
{
   ...
   inline Tupla3i( const int a, const int b, const int c);
   inline Tupla3i( const int idxv[3] );
   inline Tupla3i() {}

} ;

inline Tupla3i::Tupla3i( const int a, const int b, const int c)
{
   idx[0]=a;
   idx[1]=b;
   idx[2]=c;
...
inline Tupla3i::Tupla3i( const int idxv[3] ){
